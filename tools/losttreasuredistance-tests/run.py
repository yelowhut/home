#!/usr/bin/env python3
"""Run the LostTreasureDistance smoke tests outside of the game.

The addon is plain Lua 5.1 against the ESO API. stub.lua stands in for the
parts of that API the addon touches, so the compass label path can
...
ADDON = os.path.join(REPO, "docs", "eso", "addons", "LostTreasureDistance")
